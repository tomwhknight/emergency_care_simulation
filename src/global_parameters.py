...
class GlobalParameters:
    ...
    def __init__(self, mean_patient_arrival_time, triage_nurse_capacity, mean_triage_assessment_time, ed_doctor_capacity, mean_ed_assessment_time, mean_medical_referral, mean_initial_medical_assessment_time, mean_consultant_assessment_time, admission_probability, simulation_time, amu_bed_rate):
